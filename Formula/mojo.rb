...
class Mojo < Formula
  ...
  url "https://raw.githubusercontent.com/staycaffeinated/homebrew-mojo/main/mojo-application-0.2.1.tar.gz"
  sha256 "96965e154320715bd650ca6b6f9ae7b27ec21a1e785ede21625498858a6dc153"
  license "Apache 2.0"
  ...
  def install
    ...
    libexec.install "mojo-application-0.2.1-all.jar"
    ...
    bin.write_jar_script libexec/"mojo-application-0.2.1-all.jar", "mojo"
  end
