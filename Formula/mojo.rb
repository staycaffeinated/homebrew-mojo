...
class Mojo < Formula
  ...
  sha256 "909644c77cf9da137a39835bbccbbc2e45d467bd21556aefb7cd8af9f2861493"
  license "Apache 2.0"
  ...
  def install
    ...
    libexec.install "mojo-application-0.1.9-all.jar"
    ...
    bin.write_jar_script libexec/"mojo-application-0.1.9-all.jar", "mojo"
  end
